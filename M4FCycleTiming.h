typedef struct {
	int ex_cost;
    bool multi   = false; // is to let know if the size of reglist is to be considered
	bool dep     = false;
	bool unknown = false;
} m4f_time_t;
...
m4f_time_t M4F_time_mov_without_pc = {1};
m4f_time_t M4F_time_mov_with_pc    = {1 + P};
m4f_time_t M4F_time_add_without_pc = {1};
m4f_time_t M4F_time_add_with_pc    = {1 + P};
m4f_time_t M4F_time_sub            = {1};
m4f_time_t M4F_time_mul_1c         = {1};
m4f_time_t M4F_time_mul_2c         = {2};
m4f_time_t M4F_time_div            = {12};
m4f_time_t M4F_time_others_1c      = {1};
m4f_time_t M4F_time_ld             = {2};
m4f_time_t M4F_time_ldm            = {1, true};
m4f_time_t M4F_time_ld_pc          = {2 + P};
...
m4f_time_t M4F_time_msr            = {2};
m4f_time_t M4F_time_barriers       = {2 + B};
